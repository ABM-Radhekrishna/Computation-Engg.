...
x = linspace(0,1,N); % used for filling the values equally (x,y,z) where x and z are the starting and ending coordinates and y is the values which needs to be equally divided and assigned the values
